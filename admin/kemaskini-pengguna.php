                            ...
                            <form action="kemaskini-pengguna-proses.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="userType" name="userType" required>
                                        ...
                                        <option value="PENGGUNA" <?php echo ($user['userType'] == 'PENGGUNA') ? 'selected' : ''; ?>>PENGGUNA</option>
                                        <option value="PENTADBIR" <?php echo ($user['userType'] == 'PENTADBIR') ? 'selected' : ''; ?>>PENTADBIR</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="userStatus" class="text-gray-900">Status</label>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="userStatus" name="userStatus" value="1" <?php echo ($user['userStatus'] == 1) ? 'checked' : ''; ?>>
                                        <label class="custom-control-label" for="userStatus">Aktif</label>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="changePasswordModal" tabindex="-1" role="dialog" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="tukar-katalaluan-pengguna-proses.php" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="repeatNewPassword">Ulang Kata Laluan Baru</label>
