...
<head>
    ...
    <title>ICT BPSM - Tambah Aset</title>
    ...
    <a href="http://10.22.28.183/bpsm/dashboard" style="text-decoration: none; color: inherit;">
        <i class="uil uil-estate"></i> Kembali ke Sistem Pengurusan BPSM
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Tambah Aset ICT Baharu</h1>
                    
                    <!-- Add Asset Form -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="tambah-aset-ict-proses.php" method="post">
                                <div class="form-group">
                                    <label for="name" class="text-gray-900">Nama Pengguna</label>
                                    <input type="text" class="form-control" id="name" name="name" oninput="toUpperCase(this)" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="cawangan" name="cawangan" required>
                                        ...
                                        <option value="CAWANGAN PENTADBIRAN DAN KEWANGAN">CAWANGAN PENTADBIRAN DAN KEWANGAN</option>
                                        <option value="CAWANGAN DASAR">CAWANGAN DASAR</option>
                                        <option value="CAWANGAN NAIK PANGKAT">CAWANGAN NAIK PANGKAT</option>
                                        <option value="CAWANGAN PERKHIDMATAN">CAWANGAN PERKHIDMATAN</option>
                                        <option value="CAWANGAN LATIHAN DAN KOMPETENSI">CAWANGAN LATIHAN DAN KOMPETENSI</option>
                                        <option value="CAWANGAN PEMBANGUNAN ORGANISASI">CAWANGAN PEMBANGUNAN ORGANISASI</option>
                                        <option value="PENGURUSAN KANAN">PENGURUSAN KANAN</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="penempatan" class="text-gray-900">Nombor Penempatan</label>
                                    <input type="text" class="form-control" id="penempatan" name="penempatan" oninput="toUpperCase(this)" required>
                                </div>
                                <div class="form-group">
                                    <label for="siri" class="text-gray-900">Nombor Siri</label>
                                    <input type="text" class="form-control" id="siri" name="siri" oninput="toUpperCase(this)" required>
                                </div>
                                <div class="form-group">
                                    <label for="pcname" class="text-gray-900">Nama PC</label>
                                    <input type="text" class="form-control" id="pcname" name="pcname" oninput="toUpperCase(this)" required>
                                </div>
                                <div class="form-group">
                                    <label for="model" class="text-gray-900">Model</label>
                                    <input type="text" class="form-control" id="model" name="model" oninput="toUpperCase(this)" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status" name="status" required>
                                        ...
                                        <option value="DALAM KEADAAN BAIK">DALAM KEADAAN BAIK</option>
                                        <option value="PERLU DIBAIKI">PERLU DIBAIKI</option>
                                        <option value="PERLU DISEMAK">PERLU DISEMAK</option>
                                        <option value="DALAM PROSES PELUPUSAN">DALAM PROSES PELUPUSAN</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="pengguna" class="text-gray-900">Pengguna Sebelum</label>
                                    <input type="text" class="form-control" id="pengguna" name="pengguna" oninput="toUpperCase(this)" required>
                                </div>
                                <div class="form-group">
