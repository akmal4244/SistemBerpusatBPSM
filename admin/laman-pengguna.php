...
// Initialize variables for each user status and type
$total_active = $total_inactive = 0;
$total_pengguna = $total_pentadbir = 0;
...
// SQL Query to get the total count for each user type (pengguna and pentadbir)
...
<body id="page-top">
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>" . $row['role'] . "</td>";
                                                if ($row['userStatus'] == '1') {
                                                    echo '<td class="text-center"><i class="fas fa-check-circle text-success" title="Active"></i></td>';
                                                } else {
                                                    echo '<td class="text-center"><i class="fas fa-times-circle text-danger" title="Inactive"></i></td>';
                                                }
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Sahkan Hapus Pengguna</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    Anda pasti untuk hapus pengguna ini?
                </div>
                <div class="modal-footer">
                    <form action="hapus-pengguna.php" method="POST">
