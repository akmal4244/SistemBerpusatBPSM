    ...
    <a href="http://10.22.28.183/bpsm/dashboard" style="text-decoration: none; color: inherit;">
        <i class="uil uil-estate"></i> Kembali ke Sistem Pengurusan BPSM
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Carta</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">Jumlah Aset Mengikut Cawangan dan Jenis</h6>
                                </div>
                                <div class="card-body">
