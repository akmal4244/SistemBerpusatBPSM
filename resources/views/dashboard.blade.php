...
<div class="col-lg-6">
    <div class="card p-5 d-flex flex-column align-items-center" style="height: 100px;">
        ...
        <div class="d-flex w-100">
            ...
            <a href="http://10.22.28.183/portal/" style="text-decoration:none; flex-grow: 1;" target="_blank">
...
<div class="col-lg-6">
    <div class="card p-5 d-flex flex-column align-items-center" style="height: 100px;">
        ...
        <div class="d-flex w-100">
            ...
            <a href="http://10.22.28.183/pinas/log-masuk.php?token={{ App\Http\Helper::gettokenpinas() }}" style="text-decoration:none; flex-grow: 1;" target="_blank">
...
<div class="col-lg-6">
    <div class="card p-5 d-flex flex-column align-items-center" style="height: 100px;">
        ...
        <div class="d-flex w-100">
            ...
            <!-- Title and description -->
            <a href="{{ route('redirect.token', 'STK') }}" style="text-decoration:none; flex-grow: 1;" target="_blank">
                <h4 class="m-0">STK</h4>
...
<div class="col-lg-6">
    <div class="card p-5 d-flex flex-column align-items-center" style="height: 100px;">
        ...
        <div class="d-flex w-100">
            ...
            <!-- Title and description -->
            <a href="http://10.22.28.183/eTempah" style="text-decoration:none; flex-grow: 1;" target="_blank">
...
<div class="col-lg-6">
    <div class="card p-5 d-flex flex-column align-items-center" style="height: 100px;">
        ...
        <div class="d-flex w-100">
            ...
            <!-- Title and description -->
            <a href="{{ route('user.mgt.list') }}" style="text-decoration:none; flex-grow: 1;" target="_blank">
                <h4 class="m-0">SPP</h4>
...
<div class="col-lg-6">
    <div class="card p-5 d-flex flex-column align-items-center" style="height: 100px;">
        ...
        <div class="d-flex w-100">
            ...
            <a href="http://10.22.28.183/ictbpsm" style="text-decoration:none; flex-grow: 1;" target="_blank">
