...
// Get asset ID from URL (assume it's passed via GET)
$asset_id = $_GET['id'] ?? 0;
...
<head>
    ...
    <title>ICT BPSM - Lihat Aset</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Lihat Aset ICT</h1>
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" readonly value="<?php echo $asset['name']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="jenis" class="text-gray-900">Jenis Aset ICT</label>
                                    <input type="text" class="form-control" id="jenis" name="jenis" readonly value="<?php echo $asset['jenis']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="cawangan" class="text-gray-900">Cawangan</label>
                                    <input type="text" class="form-control" id="cawangan" name="cawangan" readonly value="<?php echo $asset['cawangan']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="penempatan" class="text-gray-900">Nombor Penempatan</label>
                                    <input type="text" class="form-control" id="penempatan" name="penempatan" readonly value="<?php echo $asset['penempatan']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="siri" class="text-gray-900">Nombor Siri</label>
                                    <input type="text" class="form-control" id="siri" name="siri" readonly value="<?php echo $asset['siri']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="pcname" class="text-gray-900">Nama PC</label>
                                    <input type="text" class="form-control" id="pcname" name="pcname" readonly value="<?php echo $asset['pcname']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="model" class="text-gray-900">Model</label>
                                    <input type="text" class="form-control" id="model" name="model" readonly value="<?php echo $asset['model']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="status" class="text-gray-900">Status</label>
                                    <input type="text" class="form-control" id="status" name="status" readonly value="<?php echo $asset['status']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="pengguna" class="text-gray-900">Pengguna Sebelum</label>
                                    <input type="text" class="form-control" id="pengguna" name="pengguna" readonly value="<?php echo $asset['pengguna']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="date" class="text-gray-900">Tarikh Kemaskini</label>
                                    <input type="text" class="form-control" id="date" name="date" readonly value="<?php echo $asset['date']; ?>">
                                </div>
