        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Kemaskini Profil Pengguna</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="kemaskini-profil-proses.php" method="post">
                                ...
                                <input type="hidden" name="emp_id" value="<?php echo $user['user_id']; ?>">

                                <div class="form-group">
                                    <label for="userFullname">Nama Penuh</label>
                                    <input type="text" class="form-control" id="userFullname" name="userFullname" value="<?php echo $user['userFullname']; ?>" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="userPass">Kata Laluan</label>
                                    <input type="password" class="form-control" id="userPass" name="userPass" value="<?php echo $user['userPass']; ?>" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="userType" name="userType" required>
                                        ...
                                        <option value="SUPERADMIN" <?php echo $user['userType'] == 'SUPERADMIN' ? 'selected' : ''; ?>>SUPERADMIN</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="userCreated">Tarikh Daftar</label>
                                    <input type="text" class="form-control" id="userCreated" name="userCreated" value="<?php echo $user['userCreated']; ?>" readonly>
                                </div>
