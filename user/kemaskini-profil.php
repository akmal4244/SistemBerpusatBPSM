...
if (isset($_GET['status'])) {
    ...
    if ($status == 'success') {
        ...
        $modalTitle = 'Ralat';
        $message = 'Katalaluan baharu tidak sepadan. Sila cuba lagi.';
        $modalType = 'danger';
    } elseif ($status == 'incorrect_password') {
        $modalTitle = 'Ralat';
        $message = 'Katalaluan semasa tidak tepat.';
        $modalType = 'danger';
    }
...
<head>
    ...
    <title>ICT BPSM - Kemaskini Profil</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">Kemaskini Profil</h1>
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form action="kemaskini-profil-proses.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="userFullname" name="userFullname" value="<?php echo htmlspecialchars($user['userFullname']); ?>" oninput="toUpperCase(this)" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <a href="#" data-toggle="modal" data-target="#changePasswordModal">Tukar Kata Laluan</a>
                                    </div>
                                </div><br>
                                <div class="form-group">
                                    <label for="userPosition" class="text-gray-900">Jawatan, Skim & Gred</label>
                                    <input type="text" class="form-control" id="userPosition" name="userPosition" value="<?php echo htmlspecialchars($user['userPosition']); ?>" oninput="toUpperCase(this)" required>
                                </div>
                                <div class="form-group">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="changePasswordModalLabel">Tukar Katalaluan</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <form action="tukar-katalaluan-profil-proses.php" method="post">
            <div class="modal-body">
              <div class="form-group">
                <label for="currentPassword" class="text-gray-900">Katalaluan Semasa</label>
                <input type="password" class="form-control" id="currentPassword" name="currentPassword" required>
              </div>
              <div class="form-group">
                <label for="newPassword" class="text-gray-900">Katalaluan Baharu</label>
                <input type="password" class="form-control" id="newPassword" name="newPassword" required>
              </div>
              <div class="form-group">
                <label for="repeatNewPassword" class="text-gray-900">Ulangi Katalaluan Baharu</label>
